...
**v0.2.2** — A model-performance harness for figuring out which LLM (local or remote) can reliably handle which kind of prompt. The end goal is an **intelligent model router** that picks the smallest model that still wins for a given task.
